...
#define RP_COMPRESSED_COUNT_MAX (DIV_ROUND_UP(RP_COMPRESSED_SIZE_MAX, ARQ_DATA_SIZE) * NWM_WORK_COUNT)
#define ARQ_PREFERRED_COUNT_MAX DIV_ROUND_UP(DIV_ROUND_UP(RP_QOS_MAX, ARQ_DATA_SIZE), 4)
