 ...
 * @sa svcControlMemory
 */
Result svcControlMemoryEx(u32* addr_out, u32 addr0, u32 addr1, u32 size, u32 op, u32 perm, bool isLoader);
 ...
 * @sa svcControlMemory
 */
Result svcControlMemoryUnsafe(u32 *out, u32 addr0, u32 size, u32 op, u32 perm);
///@}
