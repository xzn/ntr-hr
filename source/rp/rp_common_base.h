#ifndef RP_COMMON_BASE_H
#define RP_COMMON_BASE_H
...
#define RP_ENCODER_FFMPEG_JLS_ENABLE (1)
...
#define RP_FILTER_YUV_ENABLE (RP_ENCODER_FFMPEG_JLS_ENABLE || RP_ENCODER_HP_JLS_ENABLE || RP_ENCODER_ZSTD_ENABLE || RP_ENCODER_LZ4_ENABLE)
...
#define RP_KCP_SEGMENT_MALLOC_SIZE (sizeof(struct IKCPSEG) + RP_PACKET_SIZE)
